...
function HorizontalBarChart({
    ...
    useEffect(() => {
        ...
        if (selectedTopLeast === "Top 5"){
            newProductionData = newProductionData.slice(0, 5);
        } else if (selectedTopLeast === "Least 5") {
    ...
    useEffect(() => {
        ...
        if (productionData.length > 0) {
            ...
            const labels = productionData.map((item) => truncateTitle(item[labelKey]));
                ...
                datasets: [
                    {
                        ...
                        data: datasetData,
                        borderColor: selectedTopLeast === "Top 5" ?"rgb(34,139,34)" : "rgb(255, 99, 132)",
                        backgroundColor: selectedTopLeast === "Top 5" ? "rgba(119,221,119, 0.5)" : "rgba(255, 99, 132, 0.5)",
                        borderWidth: 1,
                    },
                ],
            });
            ...
            chartInstance.current = new Chart(chartContainer.current, {
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            ticks: {
                                display: false, // This will hide the x-axis ticks (numbers)
                            },
                        },
                    },
                },
